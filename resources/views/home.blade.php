...
<!-- <section class="hero">
    <div class="container">
        ...
        <a href="{{ route('booking') }}" class="btn">Book a Courier</a>
    </div>
</section> -->
...
<section class="hero">
    <video autoplay muted loop id="hero-video">
        <source src="{{ asset('videos/aeroplanevideo.mp4') }}" type="video/mp4">
...
<!-- <section class="features">
    <div class="container">
        ...
        <div class="feature-cards">
            <div class="card">
                <img src="{{ asset('images/fast.jpg') }}" alt="Fast Delivery">
                <h3>Fast Delivery</h3>
                <p>Time-bound delivery ensures your parcels reach safely and quickly.</p>
            </div>
            <div class="card">
                <img src="{{ asset('images/fast.jpg') }}" alt="Secure Handling">
                <h3>Secure Handling</h3>
                <p>Packages are handled with care and tracked at every step.</p>
            </div>
            <div class="card">
                <img src="{{ asset('images/support.png') }}" alt="24/7 Support">
                <h3>24/7 Support</h3>
                <p>Our customer service team is alws ready to help you.</p>
            </div>
            <div class="card">
                <img src="{{ asset('images/tracking.png') }}" alt="Real-Time Tracking">
...
<section class="delivery-steps">
    <div class="container">
        ...
        <div class="steps">
            <div class="step-card">
                <img src="{{ asset('images/fast.jpg') }}" alt="Book a Courier">
                <h3>Book a Courier</h3>
                <p>Schedule your pickup online in just a few clicks.</p>
            </div>
            <div class="step-card">
                <img src="{{ asset('images/pickup.jpg') }}" alt="Pickup">
                <h3>Pickup</h3>
...
<section class="about">
    <div class="container">
        ...
        <img src="{{ asset('images/fast.jpg') }}" alt="About Us Image">
    </div>
</section>
