...
<section class="hero">
    ...
    <div class="hero-content">
        <img src="{{ asset('images/logo.jpg') }}" alt="Company Logo" class="hero-logo">
...
<section class="team-section">
    ...
    <div class="team-container">
        ...
        <div class="team-card">
            <div class="team-img">
                <img src="{{ asset('images/office.jpg') }}" alt="Team Member">
            </div>
            <div class="team-info">
                <h3>Sarah Ahmed</h3>
                <h4>Project Head</h4>
        ...
        <div class="team-card">
            <div class="team-img">
                <img src="{{ asset('images/ali.jpg') }}" alt="Team Member">
            </div>
            <div class="team-info">
                <h3>Ali Khan</h3>
        ...
        <div class="team-card">
            <div class="team-img">
                <img src="{{ asset('images/maria.jpg') }}" alt="Team Member">
            </div>
            <div class="team-info">
                <h3>Maria Farooq</h3>
        ...
        <div class="team-card">
            <div class="team-img">
                <img src="{{ asset('images/hassan.jpg') }}" alt="Team Member">
            </div>
            <div class="team-info">
                <h3>Hassan Raza</h3>
